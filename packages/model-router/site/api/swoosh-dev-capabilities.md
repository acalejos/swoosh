...
`npm install @swoosh-dev/capabilities` · [source](https://github.com/acalejos/swoosh/tree/main/packages/capabilities)
...
```ts
import { CapabilityOverride, ModelCapability, CapabilityCatalog } from '@swoosh-dev/router';
