...
declare const providerRegistry: Record<string, ProviderEntry>;
interface AutoProvidersOptions {
 ...
 */
declare const createRouter: (options?: CreateRouterOptions) => Promise<ModelRouter>;

export { type AutoProvidersOptions, type CreateRouterOptions, type ProviderEntry, autoProviders, createRouter, providerRegistry };
```
